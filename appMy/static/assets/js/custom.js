...
======================================*/
    ...
    // 3.Countdown timer 
        ...
        //         $("#days").html(days + '<span class="camp">Gün</span>');
        //         $("#hours").html(hours + '<span class="camp">Saat</span>');
        //         $("#minutes").html(minutes + '<span class="camp">Dakika</span>');
        //         $("#seconds").html(seconds + '<span class="camp">Saniye</span>');       
        ...
        function makeTimer() {
            ...
            var endTime = new Date("January 7, 2024 12:00:00 ");            
            var endTime = (Date.parse(endTime)) / 1000;
    ...
    setInterval(function() { makeTimer(); }, 1001);
